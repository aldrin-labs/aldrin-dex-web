...
const TableToolbarRoot = styled(Toolbar)``

const TableToolbarSpacer = styled.div`
  flex: 1 1 100%;
`
...
const TableToolbarTitle = styled.div`
  flex: 0 0 auto;
`
...
EnhancedTableToolbar = styled(EnhancedTableToolbar)`
  padding-right: 5px;
`
...
import { withErrorFallback, withLoader } from '@hoc/index'
